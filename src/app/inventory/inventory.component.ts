...
export class InventoryComponent implements OnInit {
  ...
  {id: 4, topic: 'Java', subtopic: 'Spring', question: 'What are the benefits of working with Spring', answer: 'Lightweight, flexible and loose coupling'},
  {id: 5, topic: 'Behavioural', subtopic: 'Strengths', question: 'What do you consider your biggest strengths', answer: 'No fixed answer'},
  {id: 6, topic: 'Managerial', subtopic: 'Team Management', question: 'Would you call yourself a team player', answer: 'No fixed answer'}]
  addQuestion = false;
  interview = true;
...
updateInv() {
 const obj: question = {id: this.inventory.length + 1, topic: this.myForm.value.topic, subtopic: this.myForm.value.subtopic, question: this.myForm.value.question, answer: this.myForm.value.answer}
